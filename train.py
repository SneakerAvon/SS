...
parser.add_argument('--im_t', type=float, default=0.3, help='input masking threshold')
...
parser.add_argument('--ism_e', type=int, default=10,
...
def main():
    ...
    engine = trainer(scaler, args.in_dim, args.seq_length, args.num_nodes, args.nhid, args.dropout,
                         ...
                         adjinit, adj_mx, args.method, args.fn_t, args.em_t, args.im_t, args.ts_t, args.ism_t, args.ism_e, args.tempe, args.lam)
